import { applyNormalUpdate, applyUpdate } from './applyUpdate';
...
test('bold', () => {
    ...
    state = applyUpdate(state, handleShiftNav(state, 'ArrowRight'));
    state = applyUpdate(state, handleSpecial(state, 'b', { meta: true }));
    check(state, text([tspan('he'), tspan('l', { fontWeight: 'bold' }), tspan('lo')], true), textc('1', 1), textc('1', 0));
});
...
test('undooo the boldliness', () => {
    let state = asTop(text([tspan('hello', undefined, true)]), textc('', 2));
    state = applyUpdate(state, handleShiftNav(state, 'ArrowRight'));
    state = applyUpdate(state, handleShiftNav(state, 'ArrowRight'));
    check(state, text([tspan('hello', undefined, true)]), textc('1', 2), textc('1', 4));
    state = applyUpdate(state, handleSpecial(state, 'b', { meta: true }));
    check(state, text([tspan('he', undefined, true), tspan('ll', { fontWeight: 'bold' }, 2), tspan('o')]), textc('1', 2), textc('1', 0));
    state = applyUpdate(state, handleSpecial(state, 'b', { meta: true }));
    check(state, text([tspan('hello', undefined, true)]), textc('2', 4), textc('2', 2));
    state = applyUpdate(state, handleSpecial(state, 'u', { meta: true }));
    state = applyUpdate(state, handleSpecial(state, 'u', { meta: true }));
    state = applyUpdate(state, handleSpecial(state, 'i', { meta: true }));
    state = applyUpdate(state, handleSpecial(state, 'i', { meta: true }));
    check(state, text([tspan('hello', undefined, true)]), textc('6', 4), textc('6', 2));
});
...
test('style across spans kinda', () => {
    ...
    state = applyUpdate(state, handleSpecial(state, 'i', { meta: true }));
    check(state, text([tspan('ab'), tspan('cd', { fontWeight: 'bold', fontStyle: 'italic' })], true), textc('2', 2), textc('2', 0));
});
...
test('style across spans kinda', () => {
    ...
    state = applyUpdate(state, handleSpecial(state, 'i', { meta: true }));
    check(state, text([tspan('ab', { fontWeight: 'bold', fontStyle: 'italic' }), tspan('cd')], true), textc('1', 2), textc('1', 0));
});
